...
{ 
  ...
  {//GEN-HEADEREND:event_TableMouseClicked
    if(evt.getClickCount() == 2)
    {
      ...
      airline.presentation.user.reservations.tickets.Model viewModel = 
              new airline.presentation.user.reservations.tickets.Model(model.getElement(Table.convertRowIndexToModel(row)), dialog, controller);
      airline.presentation.user.reservations.tickets.View viewView = 
              new airline.presentation.user.reservations.tickets.View();
      airline.presentation.user.reservations.tickets.Controller viewController =
              new airline.presentation.user.reservations.tickets.Controller(viewModel, viewView);
