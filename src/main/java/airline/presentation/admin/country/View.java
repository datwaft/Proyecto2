...
{ 
  ...
  {//GEN-HEADEREND:event_ButtonAddActionPerformed
    ...
    airline.presentation.admin.country.addmodify.Model addmodifyModel = 
            new airline.presentation.admin.country.addmodify.Model(null, dialog, controller);
    airline.presentation.admin.country.addmodify.View addmodifyView = 
            new airline.presentation.admin.country.addmodify.View();
    airline.presentation.admin.country.addmodify.Controller addmodifyController =
            new airline.presentation.admin.country.addmodify.Controller(addmodifyModel, addmodifyView);
  ...
  {//GEN-HEADEREND:event_TableMouseClicked
    if(evt.getClickCount() == 2)
    {
      ...
      airline.presentation.admin.country.addmodify.Model addmodifyModel = 
              new airline.presentation.admin.country.addmodify.Model(model.getElement(Table.convertRowIndexToModel(row)), dialog, controller);
      airline.presentation.admin.country.addmodify.View addmodifyView = 
              new airline.presentation.admin.country.addmodify.View();
      airline.presentation.admin.country.addmodify.Controller addmodifyController =
              new airline.presentation.admin.country.addmodify.Controller(addmodifyModel, addmodifyView);
